...
function ApplyFileValidationRules(readerEvt) {
    ...
    if (CheckFileSize(readerEvt.size) == false) {
        alert("The file (" + readerEvt.name + ") does not match the upload conditions, The maximum file size for uploads should not exceed 8 MB");
        e.preventDefault();
        return;
    }
...
function RenderThumbnail(e, readerEvt) {
    ...
    ul.appendChild(li);
    li.innerHTML = ['<div class="img-wrap"><span class="success-icon"><i class="fas fa-check"></i></span> <span class="close">&times;</span>' +
